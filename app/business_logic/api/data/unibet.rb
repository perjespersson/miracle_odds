      ...
      class Unibet < Base
        def self.from_api_response(api_response)
          new(
            ...
            home_team_bet: api_response.dig('betOffers', 0, 'outcomes', 0, 'oddsDecimal'),
            tie_bet: api_response.dig('betOffers', 0, 'outcomes', 1, 'oddsDecimal'),
            away_team_bet: api_response.dig('betOffers', 0, 'outcomes', 2, 'oddsDecimal')
          )
        end
      end
    end
